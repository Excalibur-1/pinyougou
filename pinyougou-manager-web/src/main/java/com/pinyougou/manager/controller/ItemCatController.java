...
public class ItemCatController implements Constants {
  ...
  @Reference
  private ItemCatService baseService;
  ...
  public ItemCat findOne(Long id) {
    TbItemCat tbItemCat = baseService.findOne(id);
  ...
  public PageResult search(@RequestBody TbItemCat itemCat, int page, int rows) {
    return baseService.findPage(itemCat, page, rows);
  }
  ...
  public List<ItemCat> findByParentId(Long parentId) {
    List<TbItemCat> tbItemCatList = baseService.findByParentId(parentId);
