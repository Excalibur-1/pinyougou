...
public final class CookieUtil {
  ...
  private static String getDomainName(HttpServletRequest request) {
    ...
    if ("".equals(serverName)) {
      ...
      if (len > i) {
        // www.xxx.com.cn
        domainName = "." + domains[len - i] + "." + domains[len - 2] + "." + domains[len - 1];
      } else if (len > 1) {
        // xxx.com or xxx.cn
   ...
   * @param cookie  cookie
   */
  private static void setHostCookie(HttpServletRequest request, Cookie cookie) {
    // 设置域名的cookie
    if (null != request) {
